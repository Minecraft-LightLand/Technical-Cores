...
public class WandAddCoreRecipe extends CustomRecipe {
	...
	public static final RecipeSerializer<WandAddCoreRecipe> SERIALIZER = new SimpleCraftingRecipeSerializer<>(WandAddCoreRecipe::new);

	public WandAddCoreRecipe(ResourceLocation id, CraftingBookCategory category) {
		super(id, category);
	}
